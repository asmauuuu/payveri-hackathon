      ...
      <div className="hidden lg:flex lg:w-1/2 bg-card relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12">
          ...
          <div className="text-center animate-scale-fade-in" style={{ animationDelay: "0.6s" }}>
            ...
            <p className="text-muted-foreground text-xl font-medium mb-2">Bitcoin to Naira Made Simple</p>
            <p className="text-muted-foreground/80 text-sm">Skip the P2P stress, pay instantly</p>
          </div>
